...
void read_AssignedThreads()
{
	...
	string filename = "/home/lxy/NVM_code/RawData/ClueWeb/Feature/Regression/Predict/Cache/ClueWebGreedyPall_C"+to_string(queryFileNo)+".txt";/////////////////////
...
void initial_data()
{
	...
	read_query("/home/lxy/NVM_code/RawData/ClueWeb/Query/Cache/ClueWebQueryGreedyMiss_C"+to_string(queryFileNo)+"T.txt");
